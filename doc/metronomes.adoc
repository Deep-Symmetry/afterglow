...
TIP: This is used by the
http://deepsymmetry.org/afterglow/doc/afterglow.controllers.ableton_push.html[Ableton
Push controller binding] to display the metronome state and support
beat jumping.
