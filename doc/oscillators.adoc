...
information tracked by [[metronomes|metronomes]] into waveforms that can
be used to make lights do interesting things. They can be related to the
beats, bars, or phrases of the metronome, or multiples or fractions
thereof, and can create link:#sawtooth-oscillators[sawtooth],
link:#triangle-oscillators[triangle], link:#square-oscillators[square],
or link:#sine-oscillators[sine] waves.
...
link:#sawtooth-oscillators[sawtooth] wave related to its intervals, just
