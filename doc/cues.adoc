...
interface>> or <<mapping_sync#effect-control,Ableton Push mapping>>,
through pressure-sensitive grid controllers like the Push or
<<mapping_sync#using-launchpad-pro,Launchpad Pro>>, or a binding to
<<mapping_sync#mapping-cues-to-a-controller,any pressure-sensitive
MIDI controller>>.

Cue Variables can either be numeric, and adjusted by sliders in the
web UI, or rotary encoders and faders on MIDI controllers, or they can
store colors, in which case both the web UI and
<<mapping_sync#color-cue-parameters,Push mapping>> provide a powerful
...
the <<mapping_sync#using-ableton-push,Ableton Push>> and
<<mapping_sync#using-launchpad-pro,Novation Launchpad Pro>>, use to
...
Pro and Ableton Push mappings to be useful examples and starting
