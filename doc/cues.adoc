...
a fixture-specific function (capability), and perhaps adjust the
function level while it runs, you can use the more specific
`function-cue` described <<cues#creating-function-cues,below>>.
