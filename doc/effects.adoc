...
`head` this is being sent to (which can be used to
perform <<effects.adoc#spatial-effects,spatial>> calculations as described
above). Having all this information at hand makes it possible to write
straightforward, concise transformation functions like this one.
