...
different aspects of the fixtures they include), the same notion of
"seeing what is underneath" the fade applies, as the side which is
controlling a particular fixture or feature is faded out.
