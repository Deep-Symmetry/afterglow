...
(show/set-variable! :hue-param
  (oscillators/build-oscillated-param (oscillators/sawtooth-bar)
...
----
(def adjust-param
  (oscillators/build-oscillated-param (oscillators/sawtooth-bar) :max 360))
(show/add-effect! :color (global-color-effect
  (params/build-color-param :s 100 :l 50 :h hue-gradient
...
(defn build-saturation-transformation
  ...
  {:doc/format :markdown}
  [& {:keys [param] :or {param (oscillators/build-oscillated-param (osc/sawtooth-beat :down? true)
                                                                   :max 100)}}]
...
[source,clojure]
----
(oscillators/build-oscillated-param (oscillators/sawtooth-beat :down? true) :max 100)
----
