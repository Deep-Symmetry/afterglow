...
Since working with colors is so fundamental to creating light shows, the
mechanism for creating [[dynamic color
parameters|Dynamic-Parameters#color-parameters]] is very well developed,
and worth getting familiar with.
