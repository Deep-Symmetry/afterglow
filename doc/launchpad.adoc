...
Although when compared with the Ableton Push it lacks a text or
graphical display and rotary encoders, the Novation Launchpad Pro
makes an excellent grid controller for Afterglow, and has its own
custom {api-doc}afterglow.controllers.launchpad-pro.html[mapping].
