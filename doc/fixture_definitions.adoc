...
:api-doc: http://cdn.rawgit.com/brunchboy/afterglow/v0.2.3/api-doc/
:branch-base: https://github.com/brunchboy/afterglow/blob/v0.2.3/
...
(defn eco-uv-bar-dmx
  ...
  definitions:
  http://cdn.rawgit.com/brunchboy/afterglow/v0.2.3/api-doc/afterglow.fixtures.blizzard.html"
  []
