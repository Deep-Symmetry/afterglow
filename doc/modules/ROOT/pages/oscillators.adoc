...
image::sawtooth-beat.png[Default Sawtooth Oscillator]
...
image::sawtooth-beat-down.png[Downward
Sawtooth Oscillator]
...
image::sawtooth-beat-ratio-2.png[Sawtooth
...
image::sawtooth-beat-ratio-1-3.png[Sawtooth Oscillator with
Interval Ratio 1/3]

These can be combined, of course, so an `:interval-ratio` of `2/3`
would complete three cycles every two beats.

image::sawtooth-beat-ratio-2-3.png[Sawtooth Oscillator with
Interval Ratio 2/3]
...
image::sawtooth-beat-phase.png[Sawtooth
...
image::sawtooth-bar.png[Sawtooth Bar Oscillator]
...
image::sawtooth-phrase.png[Sawtooth Phrase Oscillator]
...
image::triangle-beat.png[Default Triangle Oscillator]
...
image::triangle-bar.png[Triangle Bar Oscillator]
...
image::triangle-phrase.png[Triangle Phrase Oscillator]
...
image::sine-beat.png[Default Sine Oscillator]
...
image::sine-bar.png[Sine Bar Oscillator]
...
image::sine-phrase.png[Sine Phrase Oscillator]
...
image::square-beat.png[Square Beat Oscillator]
...
image::square-beat-width-8.png[Square Oscillator with Width 0.8]
...
image::square-beat-width-1.png[Square Oscillator with Width 0.1]
...
image::square-bar.png[Square Bar Oscillator]
...
----
image::square-phrase.png[Square Phrase Oscillator]
