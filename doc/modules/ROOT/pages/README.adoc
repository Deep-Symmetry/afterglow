...
<<overview,overview>>, explains the <<web-ui,built in web interface>>,
and links to other sections as needed. It is worth reading through
this whole page once if you are new to Afterglow, because the
orientation it provides will be helpful, and it ends with a
<<getting-started,guide>> to help you get started on your way to
...
image::WebHome.png[Web interface]
...
image::ShowGrid.gif[Show control]
...
image::EffectList.png[The Effect List]
...
image::EffectColor.png[Effect Color Parameter Adjustment]
...
image::SavingCues.png[Saving Cues]
...
image::MakeMacro.png[Creating a Macro]
...
image::DeletingCue.png[Deleting a Cue]
...
image::EffectEnding.png[An Ending Effect]
...
image::CueScrollLink.png[Cue scroll arrows and link menu,align="right"]
...
image::GrandMaster.png[Dimmer Grand Master]
...
image::MetronomeSync.png[Metronome sync]
...
image::MetronomeSynced.png[Metronome synced]
