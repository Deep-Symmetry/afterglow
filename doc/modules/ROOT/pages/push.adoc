...
would use the <<README#web-ui,web interface>> for, and often with
...
image::PushNoEffects.jpg[Push interface]
...
image::GrandMaster.jpg[Grand Master adjustment]
...
image::ShowStop.jpg[Show stopped]
...
image::SparklePressure.jpg[Sparkle effect, ajusting chance variable]
...
image::AdjustingFade.jpg[Adjusting Fade variable]
...
image::AdjustingFocus.jpg[Adjusting Focus cue]
...
image::AdjustingDown.jpg[Adjusting a Down? cue variable]
...
image::ColorParam.jpg[Cue with color variable]
...
image::ColorPalette.jpg[Color adjustment palette]
...
image::MoreVars.jpg[More than Two Cue Variables]
...
image::Saving1.jpg[Saving Cue Variables]
...
image::PushMetronome.jpg[Metronome section]
...
image::PushBeat.jpg[Beat encoder]
