...
http://deepsymmetry.org/afterglow/doc/afterglow.show.html#var-add-midi-control-to-var-mapping[add-midi-control-to-var-mapping]
...
> See the
http://deepsymmetry.org/afterglow/doc/afterglow.show.html#var-add-midi-control-to-var-mapping[documentation] for details about all the arguments.
...
call
http://deepsymmetry.org/afterglow/doc/afterglow.midi.html#var-watch-for[afterglow.midi/watch-for]
...
See the `watch-for`
http://deepsymmetry.org/afterglow/doc/afterglow.midi.html#var-watch-for[documentation]
...
http://deepsymmetry.org/afterglow/doc/afterglow.midi.html#var-filter-devices[afterglow.midi/filter-devices]
...
corresponding red kbd:[End] pad which appears underneath them. If they
...
http://deepsymmetry.org/afterglow/doc/afterglow.controllers.launchpad-pro.html[mapping]
...
it will _replace_ the others, rather than running at the same time.
(There are photos demonstrating this effect in the Ableton Push
discussion above.)
