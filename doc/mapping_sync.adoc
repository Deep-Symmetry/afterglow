...
:api-doc: http://brunchboy.github.io/afterglow/api-doc/master/
...
{api-doc}afterglow.effects.cues.html#var-add-midi-control-to-cue-mapping[`afterglow.effects.cues/add-midi-control-to-cue-mapping`], like:
...
{api-doc}afterglow.effects.cues.html#var-add-midi-control-to-cue-mapping[documentation]
...
{api-doc}afterglow.show.html#var-remove-midi-control-to-cue-mapping[`remove-midi-control-to-cue-mapping`].
...
> See the
{api-doc}afterglow.show.html#var-add-midi-control-to-var-mapping[documentation] for details about all the arguments.
...
variable, because you will need to pass it to
{api-doc}afterglow.show.html#var-remove-midi-control-to-var-mapping[`remove-midi-control-to-var-mapping`].
Or you can simply disconnect the controller from your system, and
Afterglow will clean up any mappings that had been assigned to it.
...
If you ever want to stop using the mapped buttons, there are
corresponding functions to remove the mappings. This would undo what
we did above:

[source,clojure]
----
(afterglow.controllers.tempo/remove-midi-control-to-tempo-mapping
  "nano" 0 :control 45 tempo-map)
(afterglow.controllers.tempo/remove-midi-control-to-shift-mapping
  "nano" 0 :control 41 shift-map)
----
