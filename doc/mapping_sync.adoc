...
== Connecting to MIDI outputs on the same machine

To achive MIDI routing on the same machine, you need to set up virtual
MIDI bus. On Mac you need to use IAC bus and on Windows you could use
MIDI Yoke utility. You can find https://www.ableton.com/en/help/article/using-virtual-MIDI-buses-live/[a good tutorial] about needed steps on
