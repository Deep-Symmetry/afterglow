...
button is the down beat (the first beat of the current bar).
...
button, telling Afterglow that the closest beat to when you tapped the
button is the down beat (the first beat of a bar).
...
Afterglow that the closest beat to when you tapped the button is the
