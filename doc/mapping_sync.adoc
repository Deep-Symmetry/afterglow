...
strobe are increased by pressure, and so is the frequency with which
sparkles appear. You can see these parameters change in the text area
above the cue's effect name while you are adjusting them:

image::assets/SparklePressure.jpg[Sparkle effect adjustinc chance variable]
