...
image:assets/PushMetronome.png[Metronome section]
...
synchronized for you. The Sync pad in the Metronome section will
eventually allow you to set this up, but that is not yet implemented,
so for now you will need to use the <<README#metronome-control,web
