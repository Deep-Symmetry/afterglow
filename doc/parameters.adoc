...
works is illustrated in the
https://github.com/brunchboy/afterglow/blob/master/doc/oscillators.adoc#ratios[Ratios]
...
https://github.com/brunchboy/afterglow/blob/master/doc/mapping_sync.adoc#mapping-a-control-to-a-variable[mapping]
incoming MIDI events to it, can check the current value of the
variable at any time like this:
