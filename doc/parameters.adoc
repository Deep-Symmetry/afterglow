...
Another way could be to use a http://deepsymmetry.org/afterglow/doc/afterglow.show.html#var-add-variable-set-fn.21[specific function], that runs
every time a parameter changes. Following example prints new values of the
parameter.
