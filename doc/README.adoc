...
lights to do things by manipulating the Faders in the OLA web
...
need to create your own fixture definitions. You will want to study
existing fixture definitions for examples of how it is done. You can
also ask for help on the
...
Blizzard and has mostly fixures made by them. It includes definitions
...
Puck Fab5), an eight-head RGB system (the Weather System), and an RGB
...
. Patch your actual fixture channels and locations.

. Create the cues you want.

. Map some cues to a controller, if you have one.

. Run the show!

. Create your own custom effects if you want to be fancy.
