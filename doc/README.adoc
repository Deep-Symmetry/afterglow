...
----
The `16000` specifies the port number on which the web interface
...
https://raw.githubusercontent.com/brunchboy/afterglow/master/doc/assets/WebHome.png[Web interface]
