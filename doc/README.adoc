...
[horizontal]
 <<effect_functions#effect-functions,Effects>>::
...
<<effect_functions#effect-functions,Effects>> to the show. The default
namespace you are put into when you launch the Afterglow project using
`lein repl` has some <<effect_functions#effect-examples,example
...
the <<effect_functions#lifecycle,Effect Lifecycle>>.
